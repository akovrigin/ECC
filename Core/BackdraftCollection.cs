...
namespace Mfcom.Core.Base
{
	...
	/// <summary>
	/// Êîëëåêöèè, ðåàëèçóþùèå ýòîò èíòåðôåéñ, ïîääåðæèâàþò ðàñïðîñòðàíåíèå ïðèçíàêà "èçìåíåíî" ñ ñîäåðæàùèõñÿ â êîëëåêöèè
	/// ýëåìåíòîâ íà ñàìó êîëëåêöèþ. Ýòî ïîçâîëÿåò íå òðàòèòü âðåìÿ íà ñêàíèðîâàíèå êîëëåêöèè, åñëè â íåé íåò èçìåí¸ííûõ
	/// ýëåìåíòîâ.
	/// </summary>
	...
	/// <summary>
	/// Ñòàíäàðòíàÿ ðåàëèçàöèÿ èíòåðôåéñà IBackdraft. Îò ñòàíäàðòíîé îòëè÷àåòñÿ òåì, ÷òî 
	/// îá èçìåíåíèÿõ â õðàíÿùèõñÿ îáúåêòàõ áóäåò çíàòü è õðàíÿùàÿ êîëëåêöèÿ
	/// </summary>
	[Serializable]
